...
public class adapterTrackComp extends RecyclerView.Adapter<adapterTrackComp.MyViewHolder> {
    Context context;
    ArrayList<Complaints> list;

    public adapterTrackComp(Context context, ArrayList<Complaints> list) {
    ...
    @NonNull
    @Override
    public adapterTrackComp.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
